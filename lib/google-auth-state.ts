...
//
// El 2 de agosto de 2026 la cuenta de Google que emitió los refresh tokens fue
// borrada. Google responde `invalid_grant` con "Account has been deleted", y
// eso rompe TODO lo que toca Sheets, Drive, Docs y Search Console a la vez.
//
